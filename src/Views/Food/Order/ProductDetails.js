            ...
            <div className="flex flex-col border-b pb-4 w-full md:ml-0 md:mt-4">
              ...
              <div className="flex mt-6 flex-col">
                <div className="flex justify-between w-full">
                  <KeyValue
                    title="Menu Name"
                    value={selectedOrder.menu.name}
                  />
                </div>
                <div className="flex justify-between w-full">
                  <KeyValue title="Menu Description" value={selectedOrder.menu.description} />
                </div>
                <div className="flex justify-between w-full">
                  <KeyValue
                ...
                <div className="flex justify-between w-full">
                  <KeyValue
                    title="Delivery Time"
                    value={`${moment(selectedOrder.delivery_date, "YYYY-MM-DD").format("LL")} at ${moment(selectedOrder.delivery_time, "HH-mm a").format("LT")}`}
                  />
                </div>
                <div className="flex justify-between w-full">
                  <KeyValue
                ...
                <div className="flex justify-between w-full">
                  <KeyValue
                    ...
                    value={selectedOrder.menu.available_days.join(", ").toUpperCase()}
                  />
                </div>
                <div className="flex justify-between w-full">
                  <KeyValue
                    title="Available Time"
                    value={moment(selectedOrder.menu.available_time.join(", "), "HH:mm a").format("LT")}
                  />
                </div>
