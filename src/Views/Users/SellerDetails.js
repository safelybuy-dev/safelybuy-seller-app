...
const SellerDetails = ({ selectedSeller, setSelectedSeller }) => {
  ...
  return (
    <div
      ...
      className="fixed overflow-scroll flex justify-center top-0 left-0 z-50 w-screen py-20 px-40 md:py-0 md:px-0 h-screen bg-purple-600 bg-opacity-30"
    >
      <div
      ...
      >
        <div className="flex justify-between w-full pb-4 items-start">
          <h3 className="text-2xl">Manage User</h3>
          <span
            onClick={() => setSelectedSeller(null)}
        ...
        <div className="overflow-scroll pt-6">
          ...
          <div className="mt-8">
            <h4 className="text-lg">Access rights</h4>
            <div className="mt-6 grid grid-cols-3 gap-2 md:grid-cols-2">
              <CheckMark id="shopping" name="Shopping" />
              <CheckMark id="giftcard" name="Giftcard" />
              <CheckMark id="seller" name="Seller Management" />
              <CheckMark id="content" name="Content Management" />
              <CheckMark id="payment" name="Payment  Request" />
              <CheckMark id="delivery" name="Delivery" />
              <CheckMark id="bitcoin" name="Bitcoin" />
              <CheckMark id="email" name="Email Marketing" />
              <CheckMark id="referral" name="Referral Management" />
              <CheckMark id="tickets" name="Tickets" />
              <CheckMark id="customer" name="Customer Management" />
              <CheckMark id="user" name="User Management" />
              <CheckMark id="promotions" name="Discount & Promotions" />
            </div>
          </div>
          <div className="my-6">
            <Button primary text="Save Changes" roundedFull />
          </div>
        </div>
      </div>
    </div>
