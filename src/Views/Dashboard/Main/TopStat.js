...
function TopStat({ title, value, caption, svg, last, color, loading }) {
  if (loading)
    return (
      <div
        className={`flex ${
        ...
        <div className="flex justify-between">
          <div className="flex flex-col">
            <div className="h-6 my-2 bg-gray-200 rounded w-32" />
            <div className="h-4 my-2 bg-gray-100 rounded w-48" />
          </div>
          <div
        ...
        <div className="flex my-2 justify-between items-center">
          ...
          <div className="h-6 bg-purple-200 rounded w-1/4" />
        </div>
      </div>
    );
  return (
