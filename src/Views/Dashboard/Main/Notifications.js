...
function Notifications({ notIsVisible, setNotIsVisible, notRef, openNav }) {
  return (
    <div className="relative">
      ...
      <div ref={notRef}>
        {notIsVisible && (
          <div className="absolute w-80 -right-24 md:-right-14 mt-2 bg-white z-10 rounded-xl border-gray-100 border-2">
            ...
            <ul>
              {[
                ...
                <Link key={Date.now() + Math.random()} to={e.url}>
                  <li className="py-2 px-6 hover:bg-purple-100 flex items-center justify-between">
                    <div>
