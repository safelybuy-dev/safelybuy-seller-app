...
function KeyValueWithIcon({ title, value, heading, icon }) {
  return (
      ...
      <div
        ...
        <div className="mt-2 text-yellow-400 hidden md:block">
          <div className="relative w-8 h-4 inline-block">
            <div className="absolute animate-ping w-5 bg-yellow-100 mr-2 h-5 inline-block" />
            <div className="absolute top-1 left-1 w-3 bg-yellow-400 h-3 inline-block" />
          </div>
          Shipped
        </div>
