...
export const Transactions = () => {
  ...
  return (
    //top-[90%]
    <div
      className={`p-6  absolute  -left-8 w-full  top-[90%]   z-30  border-gray-100 border-2  rounded-xl bg-white ${styles.transaction__container}`}>
      ...
      <div className="px-4">
        ...
        <div className="">
          ...
          <div className="text-center mt-2">
            <button
              className="align-center rounded-xl hover:bg-purple-100 w-full p-4 border-gray-100 "
